...
- Prefer direct answers for simple questions. Use tools when freshness, private
 ...
 - HARD RULE — Knowledge Base First: whenever the user asks for research,
   ...
   Call `holistic_search`, `adaptive_search`, `research`, or `kb_search` as the
 ...
 - For broad or uncertain research, start with `holistic_search` or
   `adaptive_search`. Use `search_with_filters`, `timeline`,
